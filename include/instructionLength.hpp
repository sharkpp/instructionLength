...
size_t instructionLength(const uint8_t* codes)
{
	...
	for(;;)
	{
		...
		case 0xF0: case 0xF2: case 0xF3:
			...
			continue;
		// Group 2
		case 0x2E: case 0x36: case 0x3E: case 0x26: case 0x64:
		case 0x65:
			prefix = *codes++;
			continue;
		// Group 3
	...
	{
	// XX
	case 0x06: case 0x07: case 0x0E: case 0x16: case 0x17: case 0x1E: case 0x1F: case 0x27:
	case 0x2F: case 0x37: case 0x3F: case 0x48: case 0x49: case 0x4A: case 0x4B: case 0x4C:
	case 0x4D: case 0x4E: case 0x4F: case 0x50: case 0x51: case 0x52: case 0x53: case 0x54:
	case 0x55: case 0x56: case 0x57: case 0x60: case 0x61: case 0x6C: case 0x6D: case 0x6E:
	case 0x6F: case 0x90: case 0x91: case 0x92: case 0x93: case 0x94: case 0x95: case 0x96:
	case 0x97: case 0x98: case 0x99: case 0x9B: case 0x9C: case 0x9D: case 0x9E: case 0x9F:
	case 0xA4: case 0xA5: case 0xA6: case 0xA7: case 0xAA: case 0xAB: case 0xAC: case 0xAD:
	case 0xAE: case 0xAF: case 0xC3: case 0xC9: case 0xCB: case 0xCC: case 0xCE: case 0xCF:
	case 0xD7: case 0xEC: case 0xED: case 0xEE: case 0xEF: case 0xF4: case 0xF5: case 0xF8:
	...
	case 0x62: case 0x63: case 0x84: case 0x85: case 0x86: case 0x87: case 0x88: case 0x89:
	case 0x8A: case 0x8B: case 0x8C: case 0x8D: case 0x8E: case 0xC4: case 0xC5: 
	...
	case 0xCD: case 0xD4: case 0xD5: case 0xE4: case 0xE5: case 0xE6: case 0xE7: 
	case 0xA0: case 0xA2:
	case 0x6A:
		immediate = 1;
		break;
	...
	case 0xC6: 
	case 0x6B:
	case 0x80: case 0x83: case 0xC0: case 0xC1:
		presentModRM = true;
		immediate = 1;
		break;
	// XX /r id/iw
	...
	case 0x0F:
		...
		// 0F XX /r imm8
		 case 0xA4: case 0xAC: 
		// 0F XX /r ib
		case 0x70: case 0x71: case 0x72: case 0x73: case 0xBA:
